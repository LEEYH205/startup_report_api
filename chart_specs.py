...
def get_hardcoded_data():
    ...
    line_data = {
        "도소매": {
            2017: 48324, 2018: 54194, 2019: 55581, 2020: 56897,
            2021: 60874, 2022: 63470, 2023: 59843, 2024: 69293
        },
        "서비스": {
            2017: 65164, 2018: 69518, 2019: 69948, 2020: 68071,
            2021: 75102, 2022: 93298, 2023: 87107, 2024: 113790
        },
        "외식": {
            2017: 101737, 2018: 111586, 2019: 117368, 2020: 125550,
            2021: 131085, 2022: 157192, 2023: 156638, 2024: 175768
        }
    }
    ...
    return {
        ...
        "layout": {
            ...
            "xaxis": {
                ...
                "ticktext": ["2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024"]
            },
            "yaxis": {
                "title": "총 가맹점수",
                "tickformat": ",",
...
if __name__ == "__main__":
    ...
    print("\n사용 가능한 차트 사양:")
    print("1. Vega-Lite: get_vega_lite_line_chart_spec(), get_vega_lite_bar_chart_spec()")
    ...
    print("4. Chart.js: get_chartjs_line_chart_config(), get_chartjs_bar_chart_config()")
